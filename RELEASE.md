...
確保 `release/` 目錄包含：
- `RelaxTime.exe` - 可執行文件
- `RelaxTime-Setup-0.3.0.exe` - 安裝程式（如果已構建）
- `README.md` - 說明文檔
...
- 在 "Choose a tag" 中輸入 `v0.3.0`
- 選擇 "Create new tag: v0.3.0 on publish"
...
### 推薦：安裝程式
- **Inno Setup 版本**：下載 `RelaxTime-Setup-0.3.0.exe` 並執行安裝
...
1. 上傳 `RelaxTime-Setup-0.3.0.exe`（安裝程式）- **推薦**
