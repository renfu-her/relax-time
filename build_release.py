...
def build_installer():
    """構建 Inno Setup 安裝程式"""
    print_step("步驟 2: 構建 Inno Setup 安裝程式")
    ...
    # 檢查輸出文件
    installer_path = Path("installer/RelaxTime-Setup-0.5.0.exe")
...
def prepare_release():
    ...
    files_to_copy = [
        ...
        ("installer/RelaxTime-Setup-0.5.0.exe", "RelaxTime-Setup-0.5.0.exe"),
        ("README.md", "README.md"),
